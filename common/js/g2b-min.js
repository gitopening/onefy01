...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>G2B/g2b-min.js at master 路 aztack/G2B 路 GitHub</title>
...
<meta content="GJg494AE//jntcT3zU/pWA+GIgekexgTkAvlP+TJmU4=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-353ded132c604f1bdf010516392d71052f37ffcf.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/aztack/G2B/blob/8f20c843e29b13b10935341025a51f8f42cdc918/g2b-min.js'>
    <meta property="og:title" content="G2B"/>
    <meta property="og:type" content="githubog:gitrepository"/>
    <meta property="og:url" content="https://github.com/aztack/G2B"/>
    ...
    <meta property="og:description" content="G2B - A Google Map API to Baidu Map API Adapter"/>

    <meta name="description" content="G2B - A Google Map API to Baidu Map API Adapter" />
  <link href="https://github.com/aztack/G2B/commits/master.atom" rel="alternate" title="Recent Commits to G2B:master" type="application/atom+xml" />
  ...
  <body class="logged_out page-blob windows vis-public env-production " data-blob-contribs-enabled="yes">
    ...
    <ul class="top-nav logged_out">
      ...
      <li class="login"><a href="https://github.com/login?return_to=%2Faztack%2FG2B%2Fblob%2Fmaster%2Fg2b-min.js">Login</a></li>
    </ul>
      ...
      <div class="container">
        ...
        <div class="title-actions-bar">
          ...
          <li><a href="/login?return_to=%2Faztack%2FG2B" class="minibutton btn-watch watch-button entice tooltipped leftwards" rel="nofollow" title="You must be logged in to use this feature"><span><span class="icon"></span>Watch</span></a></li>
          <li><a href="/login?return_to=%2Faztack%2FG2B" class="minibutton btn-fork fork-button entice tooltipped leftwards" rel="nofollow" title="You must be logged in to use this feature"><span><span class="icon"></span>Fork</span></a></li>


      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers ">
            <a href="/aztack/G2B/watchers" title="Watchers" class="tooltipped downwards">
              4
            </a>
          </li>
          <li class="forks">
            <a href="/aztack/G2B/network" title="Forks" class="tooltipped downwards">
              2
            </a>
          </li>
        </ul>
...
<a href="/aztack" itemprop="url">            <span itemprop="title">aztack</span>
            </a> /
            <strong><a href="/aztack/G2B" class="js-current-repository">G2B</a></strong>
          </h1>
        </div>
  ...
  <ul class="tabs">
    <li><a href="/aztack/G2B" class="selected" highlight="repo_sourcerepo_downloadsrepo_commitsrepo_tagsrepo_branches">Code</a></li>
    <li><a href="/aztack/G2B/network" highlight="repo_networkrepo_fork_queue">Network</a>
    <li><a href="/aztack/G2B/pulls" highlight="repo_pulls">Pull Requests <span class='counter'>0</span></a></li>

      <li><a href="/aztack/G2B/issues" highlight="repo_issues">Issues <span class='counter'>0</span></a></li>

      <li><a href="/aztack/G2B/wiki" highlight="repo_wiki">Wiki <span class='counter'>1</span></a></li>

    <li><a href="/aztack/G2B/graphs" highlight="repo_graphsrepo_contributors">Stats &amp; Graphs</a></li>

  </ul>

  
<div class="frame frame-center tree-finder" style="display:none"
      data-tree-list-url="/aztack/G2B/tree-list/8f20c843e29b13b10935341025a51f8f42cdc918"
      data-blob-url-prefix="/aztack/G2B/blob/8f20c843e29b13b10935341025a51f8f42cdc918"
    >

  <div class="breadcrumb">
    <span class="bold"><a href="/aztack/G2B">G2B</a></span> /
    <input class="tree-finder-input js-navigation-enable" type="text" name="query" autocomplete="off" spellcheck="false">
  </div>

    <div class="octotip">
      <p>
        <a href="/aztack/G2B/dismiss-tree-finder-help" class="dismiss js-dismiss-tree-list-help" title="Hide this notice forever" rel="nofollow">Dismiss</a>
        <span class="bold">Octotip:</span> You've activated the <em>file finder</em>
        by pressing <span class="kbd">t</span> Start typing to filter the
        file list. Use <span class="kbd badmono">鈫?/span> and
        <span class="kbd badmono">鈫?/span> to navigate,
...
<div class="subnav-bar">
  ...
  <ul class="actions subnav">
    <li><a href="/aztack/G2B/tags" class="blank" highlight="repo_tags">Tags <span class="counter">0</span></a></li>
    <li><a href="/aztack/G2B/downloads" class="blank downloads-blank" highlight="repo_downloads">Downloads <span class="counter">0</span></a></li>
          ...
          <div class="context-body pane-selector commitish-selector js-filterable-commitishes">
            <div class="filterbar">
              ...
              <div class="commitish-item branch-commitish selector-item">
                <h4>
                    <a href="/aztack/G2B/blob/gh-pages/g2b-min.js" data-name="gh-pages" rel="nofollow">gh-pages</a>
                </h4>
              </div>
              <div class="commitish-item branch-commitish selector-item">
                <h4>
                    <a href="/aztack/G2B/blob/master/g2b-min.js" data-name="master" rel="nofollow">master</a>
                </h4>
              </div>
  ...
  <ul class="subnav with-scope">
    ...
    <li><a href="/aztack/G2B" class="selected" highlight="repo_source">Files</a></li>
    <li><a href="/aztack/G2B/commits/master" highlight="repo_commits">Commits</a></li>
    <li><a href="/aztack/G2B/branches" class="" highlight="repo_branches" rel="nofollow">Branches <span class="counter">2</span></a></li>
  </ul>
...
<!-- block_view_fragment_key: views7/v8/blob:v19:e78cee28c7db550966ea51d658c08c4e -->
  <div id="slider">

    <div class="breadcrumb" data-path="g2b-min.js/">
      <b itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/aztack/G2B/tree/8f20c843e29b13b10935341025a51f8f42cdc918" class="js-rewrite-sha" itemprop="url"><span itemprop="title">G2B</span></a></b> / <strong class="final-path">g2b-min.js</strong> <span class="js-clippy mini-icon clippy " data-clipboard-text="g2b-min.js" data-copied-hint="copied!" data-copy-hint="copy to clipboard"></span>
    </div>


      <div class="commit file-history-tease" data-path="g2b-min.js/">
        <img class="main-avatar" height="24" src="https://secure.gravatar.com/avatar/8484338ae884b6347c839cc7543d4788?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" width="24" />
        <span class="author"><a href="/aztack">aztack</a></span>
        <time class="js-relative-date" datetime="2011-08-01T22:53:25-07:00" title="2011-08-01 22:53:25">August 01, 2011</time>
        <div class="commit-title">
            <a href="/aztack/G2B/commit/8f20c843e29b13b10935341025a51f8f42cdc918" class="message">update map,marker event translation</a>
        </div>
        ...
        <div id="blob_contributors_box" style="display:none">
          ...
          <ul class="facebox-user-list">
            <li>
              <img height="24" src="https://secure.gravatar.com/avatar/8484338ae884b6347c839cc7543d4788?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" width="24" />
              <a href="/aztack">aztack</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="g2b-min.js/" data-permalink-url="/aztack/G2B/blob/8f20c843e29b13b10935341025a51f8f42cdc918/g2b-min.js" data-title="G2B/g2b-min.js at master 路 aztack/G2B 路 GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                  <li>
                    <a class="grouped-button file-edit-link minibutton bigger lighter js-rewrite-sha" href="/aztack/G2B/edit/8f20c843e29b13b10935341025a51f8f42cdc918/g2b-min.js" data-method="post" rel="nofollow"><span>Edit this file</span></a>
                  </li>

                <li>
                  <a href="/aztack/G2B/raw/master/g2b-min.js" class="minibutton btn-raw grouped-button bigger lighter" id="raw-url"><span><span class="icon"></span>Raw</span></a>
                </li>
                  <li>
                    <a href="/aztack/G2B/blame/master/g2b-min.js" class="minibutton btn-blame grouped-button bigger lighter"><span><span class="icon"></span>Blame</span></a>
                  </li>
                <li>
                  <a href="/aztack/G2B/commits/master/g2b-min.js" class="minibutton btn-history grouped-button bigger lighter" rel="nofollow"><span><span class="icon"></span>History</span></a>
                </li>
              </ul>
            </div>
...
<div class="frame frame-loading large-loading-area" style="display:none;" data-tree-list-url="/aztack/G2B/tree-list/8f20c843e29b13b10935341025a51f8f42cdc918" data-blob-url-prefix="/aztack/G2B/blob/8f20c843e29b13b10935341025a51f8f42cdc918">
...
<div class="lower_footer">
  <div class="container clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span title="0.05902s from fe11.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
<div id="keyboard_shortcuts_pane" class="instapaper_ignore readability-extra" style="display:none">
  ...
  <div style='display:none'>
    ...
    <div class="columns equacols">
      <div class="column first">
        <dl class="keyboard-mappings">
          <dt><span class="badmono">鈫?/span> <em>or</em> h</dt>
          <dd>Scroll left</dd>
        </dl>
        <dl class="keyboard-mappings">
          <dt><span class="badmono">鈫?/span> <em>or</em> l</dt>
          <dd>Scroll right</dd>
        </dl>
        <dl class="keyboard-mappings">
          <dt><span class="badmono">鈫?/span> <em>or</em> k</dt>
          <dd>Scroll up</dd>
        </dl>
        <dl class="keyboard-mappings">
          <dt><span class="badmono">鈫?/span> <em>or</em> j</dt>
          <dd>Scroll down</dd>
        </dl>
        <dl class="keyboard-mappings">
          <dt>t</dt>
      ...
      <div class="column last">
        <dl class="keyboard-mappings">
          <dt>shift <span class="badmono">鈫?/span> <em>or</em> shift h</dt>
          <dd>Scroll all the way left</dd>
        </dl>
        <dl class="keyboard-mappings">
          <dt>shift <span class="badmono">鈫?/span> <em>or</em> shift l</dt>
          <dd>Scroll all the way right</dd>
        </dl>
        <dl class="keyboard-mappings">
          <dt>shift <span class="badmono">鈫?/span> <em>or</em> shift k</dt>
          <dd>Scroll all the way up</dd>
        </dl>
        <dl class="keyboard-mappings">
          <dt>shift <span class="badmono">鈫?/span> <em>or</em> shift j</dt>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.06131' data-host='fe11'></span>
  </body>
</html>
